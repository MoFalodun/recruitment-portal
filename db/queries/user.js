module.exports = {
  ...
  fetchAllUsers: `SELECT CONCAT(first_name, ' ', last_name) as name , id, email, date_of_birth, address, university, cgpa, score FROM user_info WHERE application_status = 'Pending';`,
